...
\end{itemize}
We additionally describe a retrieval-inference pipelining optimization that overlaps retrieval I/O with system-prompt prefill. This is a secondary, orthogonal contribution that benefits cold-start requests and is independent of the ordering mechanism.
