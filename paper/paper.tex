...
We evaluate on two GPU configurations, four model sizes across two architectures, and six workloads spanning a Jaccard overlap range of 0.06--0.88 (synthetic bursty, overlap sweep, geospatial, NQ-Open-derived, mixed-topic, and real-corpus TF-IDF), and show that simple prompt-layer ordering captures most of the available APC benefit.
