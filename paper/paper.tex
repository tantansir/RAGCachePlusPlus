...
\item \textbf{RQ4.} Can a TTFT-based feedback loop keep the trie synchronized with vLLM's actual cache state without engine instrumentation? \emph{(Section~\ref{sec:feedback}; Section~\ref{sec:trie_valid}; Section~\ref{sec:integrated})}
